...
Damit FHEM das Homebrew-Device richtig erkennt, muss die HBW-LC-Bl4.xml Datei in den Ordner \FHEM\lib\HM485\Devices\xml kopiert werden (Das Device gibt sich als HW-Typ 0x82 aus).
