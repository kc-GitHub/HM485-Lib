...
int blindTimeTopBottom[4];
int blindTimeBottomTop[4];
...
void getCurrentPosition(byte channel) {
  ...
  if (blindCurrentState[channel] == MOVE)
    if (blindDirection[channel] == UP) {
      blindPositionActual[channel] -= (now - blindTimeStart[channel]) / blindTimeBottomTop[channel];
      if (blindPositionActual[channel] > 100) blindPositionActual[channel] = 0; // robustness
      blindAngleActual[channel] = 0;
    }
    else {
      blindPositionActual[channel] += (now - blindTimeStart[channel]) / blindTimeTopBottom[channel];
      if (blindPositionActual[channel] > 100) blindPositionActual[channel] = 100; // robustness
    ...
    if (blindDirection[channel] == UP) {
      ...
      if (blindAngleActual[channel] > 100) blindAngleActual[channel] = 0; // robustness
    }
    else {
      blindAngleActual[channel] += (now - blindTimeStart[channel]) / config.blinds[channel].blindTimeChangeOver;
      if (blindAngleActual[channel] > 100) blindAngleActual[channel] = 100; // robustness
    }
}
  ...
  for (byte channel = 0; channel < 4; channel++) {
	  if ((blindForceNextState[channel] == true) || (now >= blindTimeNextState[channel])) {
		...
		case RELAIS_OFF:
		  ...
		  // debug message
		  // hmwdebug(millis()); hmwdebug(" "); hmwdebug("RELAIS OFF "); hmwdebug(" "); hmwdebug(blindPositionActual); hmwdebug(" "); hmwdebug(blindPositionRequested); hmwdebug("Angle: "); hmwdebug(blindAngleActual);
		...
		case WAIT:
		  ...
		  // debug message
		  // hmwdebug(now); hmwdebug(" "); hmwdebug("WAIT       "); hmwdebug(" "); hmwdebug(blindPositionActual); hmwdebug(" "); hmwdebug(blindPositionRequested); hmwdebug("Angle: "); hmwdebug(blindAngleActual);
		...
		case MOVE:
		  ...
		  // debug message
		  // hmwdebug(millis()); hmwdebug(" "); hmwdebug("MOVE       "); hmwdebug(" "); hmwdebug(blindPositionActual); hmwdebug(" "); hmwdebug(blindPositionRequested[channel]); hmwdebug("Angle: "); hmwdebug(blindAngleActual[channel]);
		...
		case STOP:
		  ...
		  // debug message
		  // hmwdebug(now); hmwdebug(" "); hmwdebug("STOP       "); hmwdebug(" "); hmwdebug(blindPositionActual); hmwdebug(" "); hmwdebug(blindPositionRequested[channel]); hmwdebug("Angle: "); hmwdebug(blindAngleActual[channel]);
		...
		case TURN_AROUND:
		  ...
		  // debug message
		  // hmwdebug(now); hmwdebug(" "); hmwdebug("TURN_AROUND"); hmwdebug(" "); hmwdebug(blindPositionActual); hmwdebug(" "); hmwdebug(blindPositionRequested[channel]); hmwdebug("Angle: "); hmwdebug(blindAngleActual[channel]);
		...
		case SWITCH_DIRECTION:
		  ...
		  // debug message
		  // hmwdebug(now); hmwdebug(" "); hmwdebug("SWITCH_DIR "); hmwdebug(" "); hmwdebug(blindPositionActual[channel]); hmwdebug(" "); hmwdebug(blindPositionRequested[channel]);
